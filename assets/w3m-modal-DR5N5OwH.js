import{p as ve,w as fe,s as ge,a as be,R as l,M as g,S as se,i as v,r as P,c as f,x as a,A as K,e as ce,d as le,C as m,f as Y,g as ye,h as S,E as ie,O as E,j as q,k as oe,l as T,m as H,T as xe,n as Ce,o as ke,q as Se}from"./core-DQflmJJ8.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-C8u4_ehX.js";import"./index-BCwnMMId.js";import"./index.es-BafYF_1d.js";import"./events-DQ172AOg.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return be(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
